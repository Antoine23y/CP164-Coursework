...
class List:
    ...
    def _linear_search(self, key):
        ...
        if self._front is None:
            ...
            while curr is not None and found == False:
                if curr._value == key:
                    found = True
                else:
                    index += 1
    ...
    def __eq__(self, target):
        ...
        if self._count != target._count:
            ...
            while equals == True and curr is not None:
                if curr._value != curr_target._value:
                    equals = False
                curr = curr._next
    ...
    def intersection(self, source1, source2):
        ...
        if source1._front is not None and source2._front is not None:
            ...
            while curr is not None:
                # check if it is in the second list
                _, _, index = source2._linear_search(curr._value)

                # check if value repeats
                _, _, index2 = self._linear_search(curr._value)
    ...
    def union(self, source1, source2):
        ...
        if source1._front is not None:
            curr = source1._front
            _, _, index = self._linear_search(curr._value)
    ...
    def _move_front_to_front(self, source):
        ...
        # your code here
        node = _List_Node(source._front._value, self._front)
    ...
    def _move_front_to_rear(self, source):
        ...
        # your code here
        node = _List_Node(source._front._value, None)

        # remove value from source
