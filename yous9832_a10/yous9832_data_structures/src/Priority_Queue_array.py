...
class Priority_Queue:
    ...
    def _set_first(self):
        ...
        if len(self._values) == 0:
            ...
            priority_value = self._values[0]
            priority_value_index = 0

            for v in range(len(self._values)):
                if self._values[v] < priority_value:
                    priority_value = self._values[v]
                    priority_value_index = v

            self._first = priority_value_index
