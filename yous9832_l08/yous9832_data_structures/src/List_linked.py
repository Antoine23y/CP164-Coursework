...
class List:
    ...
    def prepend(self, value):
        ...
        if self._front is None:
            ...
            new_node = _List_Node(value, temp_node)
            self._front = new_node
    ...
    def __getitem__(self, i):
        ...
        value = deepcopy(temp_node._value)
    ...
    def __contains__(self, key):
        ...
        """
        # your code here
        prev, cur, index = self._linear_search(key)
    ...
    def max(self):
        ...
        while temp_node != self._rear:

            if temp_node._value > max_data:

                max_data = temp_node._value

            temp_node = temp_node._next

        if self._rear is not None and self._rear._value > max_data:

            max_data = self._rear._value
    ...
    def min(self):
        ...
        while temp_node != self._rear:
            ...
            if temp_node._value < min_data:

                min_data = temp_node._value

            temp_node = temp_node._next

        if self._rear is not None and self._rear._value < min_data:

            min_data = self._rear._value
    ...
    def count(self, key):
        ...
        while temp_node != self._rear:
            ...
            if temp_node._value == key:

                number += 1

            temp_node = temp_node._next

        if self._rear is not None and self._rear._value == key:
    ...
    def is_identical_r_aux(self, self_node, other_node):
        ...
        if self_node is None or other_node is None:
            ...
            identical = self.is_identical_r_aux(
                self_node._next, other_node._next)
