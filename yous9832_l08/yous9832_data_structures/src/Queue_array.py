...
class Queue:
    ...
    def __eq__(self, target):
        ...
        while i < len(self._values) and self._values[i] != None:

            if start_index == len(target._values) - 1:

                if self._values[i] != target._values[start_index]:

                    equal = False

                start_index = 0

            elif target._values[start_index + 1] == None:
