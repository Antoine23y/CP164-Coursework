...
class Sorted_List:
    ...
    def clean(self):
        ...
        while i < len(self._values):
            ...
            if self._values[i] == self._values[i]:
    ...
    def intersection(self, source1, source2):
        ...
        for item in source1._values:
            ...
            if item not in duplicate and item not in self._values:
                ...
                while low <= high:
                    ...
                    if item < self._values[mid]:
                        # search the left subarray.
                        high = mid - 1
                    else:
                        # Default: search the right subarray.
                        low = mid + 1
                self._values.insert(low, item)
    ...
    def split(self):
        ...
        if len(self._values) % 2 != 0:
            ...
            split_index = (int(len(self._values)/2)) + 1

        else:

            split_index = int(len(self._values)/2)
